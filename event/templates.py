...
template_update_cog = '''
现在你将基于指定的 5 类参考数据，完成个人长期记忆更新。主要关注今日生活带来的变化和原长期记忆：
1. 长期记忆更新
核心筛选标准：优先选择「有用 / 重要 / 后续可能常用」的信息，具体包括四类内容：一是客观事实与固定偏好（如 “我常去 XX 银行，已在此办理常驻业务”“家附近超市的营业时间为 8:00-22:00”“我常去XX健身房，在此办了卡”）；二是印象深刻的关键事件（如 “首次完成项目独立交付”“与家人确定春节旅行目的地”）；三是重复多次进行的事件的总结（如 “连续一周 18:30 去健身房锻炼，形成最近经常锻炼的记忆”）。四、对过去生活做一个总结概况。
...
3）与个人画像、近期记忆比对：- 依据日期属性（工作日/周末）匹配对应作息；- 结合个人习惯与特质，对事件进行适配性调整以符合自身行为模式。
