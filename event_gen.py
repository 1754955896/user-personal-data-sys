...
persona = '''
    ...
    '''
scheduler = Scheduler(persona)
scheduler.main_gen_event()
#输出位于data文件中的event.json
json_data = read_json_file('data/event.json')
scheduler.main_schedule_event(json_data,'data/')
#输出位于data文件中的event_s.json
json_data = read_json_file('data/event_s.json')
scheduler.main_decompose_event(json_data,'data/')
